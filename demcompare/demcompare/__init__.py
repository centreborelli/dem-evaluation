...
def run(
    ...
    if "statistics" in cfg:
        ...
        for dem_processing_method in cfg["statistics"]:
            ...
            # compute and save differences histogram
            plot_file_path_histogram = os.path.join(os.path.dirname(plot_file_path), "diff_hist.png")
            difference_histogram(
                dem=stats_dem,
                plot_path=plot_file_path_histogram,
                q_min = 0.05,
                q_max = 0.95
            )
